...
using SistemaVentas.VISTA.ActividadVenta5Vista;
using System;
...
namespace SistemaVentas.VISTA.Actividad5Vista
{
    public partial class RegistrarVentaVista : Form
    {
        ...
        ListarVentaBss venta = new ListarVentaBss();
        private void button2_Click(object sender, EventArgs e)
        {
            ListarDetalleVentaVista listarventas = new ListarDetalleVentaVista();
            if (listarventas.ShowDialog() == DialogResult.OK)
            {
                dataGridView1.DataSource = venta.ListarVentas();
            }
        }
